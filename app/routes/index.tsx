...
export default createRoute((c) => {
  return c.render(
    <div class={"grid grid-cols-2 gap-7 mt-6 md:mt-12 px-6"}>
      {/* Profile */}
      <div class={"flex flex-col items-center p-6 bg-card rounded-3xl col-span-2"}>
        <div>
          <img
          ...
          <div class={"mt-4 md:mt-6 ml-2"}>
            ...
            <p class={"text-sm md:text-base mt-2 md:mt-3 text-neutral-600 dark:text-neutral-400"}>
              I'm a front-end developer and can do a little back-end as well.
            </p>
            <a href="/about" class={"hidden mt-2 items-center w-fit hover:text-primary group"}>
              About me
              <svg
      ...
      >
        ...
        <p class={"grow text-gray-800 text-center font-extrabold text-2xl md:text-4xl"}>Blog</p>
      </a>
      {/* Twitter */}
      <a
